...
This script is taken from the library Warmup Scheduler Pytorch. Github: https://github.com/LEFTeyex/warmup
The author is LEFTeyes (https://github.com/LEFTeyex). The library is licensed under the MIT License.
Do not forget to thank the author for his work on the GitHub page of the library.
